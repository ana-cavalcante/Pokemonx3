class bulbasaur:
  ...
  def choqueDoTrovao(self, pokemon):
    print("\n {} diz: Bulbasaur! choque do trovão!".format(self.__treinador))
    self.__mp = self.__mp - 15
    pokemon.receberDano(35)
  
  def caudaDeFerro(self, pokemon):
    print("\n {} diz: Bulbasaur! cauda de ferro nele!".format(self.__treinador))
    self.__mp = self.__mp - 5
    pokemon.receberDano(15)
  
  def investidaDoTrovao(self, pokemon):
    print("\n {} diz: Bulbasaur! investida do trovão!".format(self.__treinador))
    self.__mp = self.__mp - 5
  ...
  def receberDano(self, valorDoDano):
    ...
    print("Bulbasaur de {} recebe {} de dano".format(self.__treinador, valorDoDano))
    if ((self.getHP()-valorDoDano)) <= 0:
      print("Bulbasaur de {} esta fora de combate.".format(self.__treinador))
